...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->SortFields = array(   
		1 => '`orders`.`OrderID`',
		2 => '`customers1`.`CompanyName`',
		3 => 3,
		4 => '`orders`.`OrderDate`',
		5 => '`orders`.`RequiredDate`',
		6 => '`orders`.`ShippedDate`',
		7 => '`shippers1`.`CompanyName`',
		8 => '`orders`.`Freight`',
		9 => '`customers1`.`CompanyName`',
		10 => '`customers1`.`Address`',
		11 => '`customers1`.`City`',
		12 => '`customers1`.`Region`',
		13 => '`customers1`.`PostalCode`',
		14 => '`customers1`.`Country`'
	);
