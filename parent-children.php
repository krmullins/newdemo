		...
		$pcConfig = array(
			...
			'employees' => array(   
				'ReportsTo' => array(   
					...
					'sortable-fields' => array(0 => '`employees`.`EmployeeID`', 1 => '`employees`.`TitleOfCourtesy`', 2 => '`employees`.`Photo`', 3 => '`employees`.`LastName`', 4 => '`employees`.`FirstName`', 5 => '`employees`.`Title`', 6 => '`employees`.`BirthDate`', 7 => '`employees`.`HireDate`', 8 => '`employees`.`Address`', 9 => '`employees`.`City`', 10 => '`employees`.`Region`', 11 => '`employees`.`PostalCode`', 12 => '`employees`.`Country`', 13 => '`employees`.`HomePhone`', 14 => '`employees`.`Extension`', 15 => '`employees`.`Notes`', 16 => '`employees`.`ReportsTo`'),
					'records-per-page' => 10,
					'default-sort-by' => 3,
			...
			'orders' => array(   
				'CustomerID' => array(   
					...
					'sortable-fields' => array(0 => '`orders`.`OrderID`', 1 => '`orders`.`CustomerID`', 2 => '`orders`.`EmployeeID`', 3 => '`orders`.`OrderDate`', 4 => '`orders`.`RequiredDate`', 5 => '`orders`.`ShippedDate`', 6 => '`orders`.`ShipVia`', 7 => '`orders`.`Freight`', 8 => '`orders`.`ShipName`', 9 => '`orders`.`ShipAddress`', 10 => '`orders`.`ShipCity`', 11 => '`orders`.`ShipRegion`', 12 => '`orders`.`ShipPostalCode`', 13 => '`orders`.`ShipCountry`'),
					'records-per-page' => 10,
					'default-sort-by' => 0,
			...
			'order_details' => array(   
				'OrderID' => array(   
					...
					'sortable-fields' => array(0 => '`order_details`.`odID`', 1 => '`order_details`.`OrderID`', 2 => '`order_details`.`ProductID`', 3 => '`order_details`.`Category`', 4 => '`order_details`.`UnitPrice`', 5 => '`order_details`.`Quantity`', 6 => '`order_details`.`Discount`'),
					'records-per-page' => 10,
					'default-sort-by' => 1,
					'default-sort-direction' => 'asc',
					'open-detail-view-on-click' => true,
			...
			'products' => array(   
				'SupplierID' => array(   
					...
					'sortable-fields' => array(0 => '`products`.`ProductID`', 1 => '`products`.`ProductName`', 2 => '`products`.`SupplierID`', 3 => '`products`.`CategoryID`', 4 => '`products`.`QuantityPerUnit`', 5 => '`products`.`UnitPrice`', 6 => '`products`.`UnitsInStock`', 7 => '`products`.`UnitsOnOrder`', 8 => '`products`.`ReorderLevel`', 9 => '`products`.`Discontinued`'),
					'records-per-page' => 10,
					'default-sort-by' => 1,
					'default-sort-direction' => 'asc',
					'open-detail-view-on-click' => true,
